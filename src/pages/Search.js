...
import SetCourseFilterParams from "../components/course/SetCourseFilterParams";
import CourseFilterForm from "../components/course/CourseFilterForm";
import CourseSearchResults from "../components/course/CourseSearchResults";
import SearchResultCount from "../components/SearchResultCount";
import CourseSortForm from "../components/course/CourseSortForm";
		...
		<Container className="Search">
			...
			<Row columns={16}>
				<Col xs={12} md={4} lg={3} style={{ marginBottom: "20px" }}>
					...
					<Divider />
					<center>
						<AdSlot slot={process.env.REACT_APP_ADSENSE_SIDEBAR_SLOT} adWidth={"250px"} adHeight={"250px"} />
					</center>
				</Col>
				<Col xs={12} md={8} lg={9}>
					<Row middle="xs">
