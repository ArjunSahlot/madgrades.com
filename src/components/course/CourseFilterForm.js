		...
		return (
			<Form onSubmit={this.onSubmit}>
				...
				<Form.Field>
					...
					<EntitySelect value={subjects || []} onChange={this.onSubjectChange} entityType="subject" />
				</Form.Field>
				<Form.Field>
					<label>Instructors</label>
					<EntitySelect value={instructors || []} onChange={this.onInstructorChange} entityType="instructor" />
				</Form.Field>
